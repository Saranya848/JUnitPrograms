...
public class UserDetails {
	...
	public boolean firstName(String firstName) throws UserRegistrationException{
		...
		if (m.matches() == true) {
			...
			throw new UserRegistrationException("Try valid Input");
		}
		return m.matches();
	}
	 ...
	 * @return
	 */
	public static boolean phoneNum(String phoneNum) throws UserRegistrationException{
		input = "^\\+(?:[0-9] ?){6,14}[0-9]$";
	 ...
	 * @return
	 */
	public boolean sampleEmails(String email) throws UserRegistrationException{
	 ...
	 * @return
	 */
	//public String moodAnalyzer(String firstName, String lastName, String phoneNum, String email, String password) throws UserRegistrationException {
